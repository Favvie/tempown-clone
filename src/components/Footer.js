...
const Footer = () => {
    return (
      ...
      <footer className='bg-[#F9F9F9]  mt-10 w-full px-10 py-8 container mx-auto'>
            ...
            <div className='grid lg:grid-cols-3 md:grid-cols-2 sm-grid-cols-1 gap-6 md:gap-0'>
                ...
                <div className='flex flex-col gap-4'>
                    ...
                    <a href='/' className='flex  items-center gap-3 text-white px-4 py-3 font-semibold bg-primary bg-gradient-to-r from-[#266d4d] to-primary rounded-xl w-[55%] text-xs'>CONTACT US <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12.5906 1.01074H2.39476C1.32874 1.01074 0.461426 1.87789 0.461426 2.94408V9.18371C0.461426 10.2475 1.32497 11.1133 2.3879 11.117V13.9485L6.45704 11.117H12.5906C13.6566 11.117 14.5239 10.2497 14.5239 9.18371V2.94408C14.5239 1.87789 13.6566 1.01074 12.5906 1.01074ZM13.6999 9.18371C13.6999 9.79534 13.2023 10.2931 12.5906 10.2931H6.19852L3.21187 12.3714V10.2931H2.39476C1.78305 10.2931 1.2854 9.79534 1.2854 9.18371V2.94408C1.2854 2.33228 1.78305 1.83472 2.39476 1.83472H12.5906C13.2023 1.83472 13.6999 2.33228 13.6999 2.94408V9.18371Z" fill="#4CE797"></path><path d="M4.22522 3.92212H10.7602V4.74609H4.22522V3.92212Z" fill="#4CE797"></path><path d="M4.22522 5.67993H10.7602V6.50391H4.22522V5.67993Z" fill="#4CE797"></path><path d="M4.22522 7.43774H10.7602V8.26172H4.22522V7.43774Z" fill="#4CE797"></path></svg></a>
